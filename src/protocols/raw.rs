        ...
        mod generated {
            pub mod server {
                ...
                pub mod __interfaces {
                    ...
                    wayland_scanner::generate_interfaces!("resources/niri-wallpaper-v1.xml");
                }
                use self::__interfaces::*;

                wayland_scanner::generate_server_code!("resources/niri-wallpaper-v1.xml");
            }
        }
    }
}
